...
static libpsutil::symbol <int(int* unk, XAssetType type, const char* name, bool errorIfMissing, int waitTime) > DB_FindXAssetHeader{ static_cast<int>(game_table::db_findxassetheader) };
